...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        ...
        toilet -f mono12 -F border devilboy6
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/gnuinelife6 \e[0m"
    echo -e "\e[4;32m           YouTube: https://youtube.com/channel/UCQf9hcowDB6WbcBA_Rq7Yzg \e[0m"
    echo " "
...
do
    banner
    echo -e "\e[4;31m Please Read Instruction Carefully, All are the part of callbomber which is created by gopal!!! \e[0m"
    echo " "
